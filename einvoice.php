...
if (isset($_POST['invoice'])) {
    require_once("./einvoice_run.php");
    header("location: ./einvoice");
}
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="einvoice"><i class="zmdi zmdi-upload"></i><span>E-Way Bill Genarete</span> </a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active">E Invoice Generate</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form method="post">
                                <button style="display: block;" class="btn  btn-raised btn-success waves-effect" id="submit" type="submit" name="invoice" value="invoice">Generate E-Invoice and E-way Bill</button>
