...
"ForceRefreshAccessToken": true
    ...
    $irn_no = "SELECT * From einvoice where AckNo = " . $_POST['ack_no'] . " ORDER BY id DESC LIMIT 1";
    $result = mysqli_query($connect, $irn_no);
    $row = mysqli_fetch_array($result);
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://einv-apisandbox.nic.in/eicore/v1.03/Invoice/irn/' . $row['Irn'],
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    $irn = curl_exec($curl);
    curl_close($curl);
    $irn_de = json_decode($irn, true);
    $get_irn = $irn_de['Data'];
    $irn_details = json_decode(decryptBySymmetricKeyi($get_irn, $sekB64), true);
}
?>
<!doctype html>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li class="active open"><a href="get_irn"><i class="zmdi zmdi-shopping-cart"></i><span>IRN Details</span> </a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active">Get IRN Details</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="ack_no" maxlength="15" minlength="15" required>
                                        <label class="form-label">Ack Number</label>
                                    </div>
                                    <div class="help-info">Enter the Ack Number</div>
                                </div>
                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php if (isset($irn_details['AckNo'])) {
                                                echo $irn_details['AckNo'];
                                            } else {
                                                echo "-";
                                            }  ?></td>
                                        <td><?php if (isset($irn_details['AckDt'])) {
                                                echo $irn_details['AckDt'];
                                            } else {
                                                echo "-";
                                            }  ?></td>
                                        <td><?php if (isset($irn_details['Status'])) {
                                                echo $irn_details['Status'];
                                            } else {
                                                echo "-";
                                            }  ?></td>
                                        <td><?php if (isset($irn_details['EwbNo'])) {
                                                echo $irn_details['EwbNo'];
                                            } else {
                                                echo "-";
                                            }  ?></td>
                                        <td><?php if (isset($irn_details['EwbDt'])) {
                                                echo $irn_details['EwbDt'];
                                            } else {
                                                echo "-";
                                            }  ?> </td>
                                        <td><?php if (isset($irn_details['EwbValidTill'])) {
                                                echo $irn_details['EwbValidTill'];
                                            } else {
                                                echo "-";
                                            }  ?> </td>
                                        <td><?php if (isset($irn_details['Remarks'])) {
                                                echo $irn_details['Remarks'];
                                            } else {
                                                echo "-";
                                            }  ?> </td>
                                    </tr>
